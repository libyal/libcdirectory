...
#if !defined( _LIBCDIRECTORY_EXTERN_H )
#define _LIBCDIRECTORY_EXTERN_H

/* To export functions from the libcdirectory DLL define LIBCDIRECTORY_DLL_EXPORT
 * To import functions from the libcdirectory DLL define LIBCDIRECTORY_DLL_IMPORT
