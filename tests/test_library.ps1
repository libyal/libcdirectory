...
$LibraryTests = "directory_entry error support system_string"
$LibraryTestsWithInput = "directory"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\cdirectory_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libcdirectory"
