...
#if !defined( _LIBCDIRECTORY_WIDE_STRING_H )
...
#define wide_string_compare_no_case( string1, string2, size ) \
	libcdirectory_wide_string_compare_no_case( string1, string2, size )
...
int libcdirectory_wide_string_compare_no_case(
...
#endif /* !defined( _LIBCDIRECTORY_WIDE_STRING_H ) */
